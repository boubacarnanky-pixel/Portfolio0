...
/* ============================================================
   ...
   Portfolio Boubacar Nanky — Partie 2 PHP → Partie 3

   CORRECTIF AUDIT FINAL : ajout de la connexion PDO et de la
   journalisation des visites, manquantes jusqu'ici sur cette
   page (contrairement à index.php, contact.php, portfolio.php).
   ============================================================ */
...
<body id="top">
  ...
  enregistrer_visite($pdo, 'services');
  ?>
