    ...
    <div class="footer__inner">
      ...
      <div class="footer__social">
        ...
        <div class="footer__social-icons">
          <a href="https://instagram.com/benz_talent" target="_blank" rel="noopener" class="social-icon" aria-label="Instagram">
          ...
          <a href="https://linkedin.com/Boubacar Nanky" target="_blank" rel="noopener" class="social-icon" aria-label="LinkedIn">
